...
def createModel(G,start,end):
    """ Create an ILP for the min asymmetric Path TSP 
        ...
        Arguments:
            ...
            start -- a node of the Graph G, in which the ATSP path should start 
            end -- a node of the Graph G, in which the ATSP path should end
...
def extractSolution(G, model):
    """ Get the optimal tour in G 
        ...
        Arguments:
            G     -- a weighted ILPGraph
            model -- a solved Gurobi model for min asymmetric Path TSP 
