...
def proposition13(G, radius, upperBound):
    ...
    for node in nodes:
        dNearestTerminal = pcst_utilities.d_nearest_terminals_root(G, node, terminals, numberOfNearestTerminals=2)
...
def corollary14(G, radius_list, radius_dict, upperBound):
    ...
    for t in terminals:
        ...
        # Für den Fall, dass das Terminal mit keinem anderen Terminal verbunden ist kann ich das Terminal direkt
        # löschen, da wir für das Korollar von min 2 Terminals ausgehen
